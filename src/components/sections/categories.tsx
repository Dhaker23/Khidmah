        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5">
          {categories.map((cat, i) => {
            ...
            return (
              ...
              >
                <Card className="h-full p-5 border-border/60 hover:border-[#32504d]/40 khidma-card overflow-hidden relative">
                  <div
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <ArrowUpRight className="size-4 text-muted-foreground/60 transition-all duration-200 group-hover:text-[#32504d] group-hover:-translate-y-0.5 group-hover:translate-x-0.5" />
                  </div>
